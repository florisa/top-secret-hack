...
################################################################ 
    ...
    def rf_randomsearch(self, features, targets, model_name, test_size = 0.25):
        ...
        model_random = MultiOutputRegression(model_random)
        model_random.fit(x_train, y_train)
        
        # Save model
        joblib.dump(model_random, model_name)
...
if __name__ == "__main__":
    ...
    if args["model"] == "Random Forest":
        model = Models()
        best_parameters, accuracy = model.rf_randomsearch(features, targets, model_name = "RF_RandomSearch.sav")
